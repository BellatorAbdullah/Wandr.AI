...
app.post('/api/generate-itinerary', async (req, res) => {
    try {
        ...
        const prompt = `
            Plan a detailed "Buddymoon" trip based on these details: ${JSON.stringify(answers)}.

            ### STRICT FORMATTING RULES:
            1. **Header Image**: Start with an image of the destination: ![Destination](https://source.unsplash.com/800x400/?${answers.destination},landscape)
            ...
            4. **Visuals**: Between each day, include one Unsplash image link: ![Activity](https://source.unsplash.com/800x400/?${answers.destination},landmark)
            5. **Food**: Use blockquotes (>) for vegetarian restaurant recommendations.
        `;
